...
-keep class com.xlkj.beautifulpicturehouse.module.home.bean.** { *; }
-keep class com.xlkj.beautifulpicturehouse.module.video.bean.** { *; }
-keep class com.xlkj.beautifulpicturehouse.module.mine.bean.** { *; }

#Form-encoded method must contain at least one @Field.for method a.a这个报错是下面有的东西要保持不混淆
-keep class com.xlkj.beautifulpicturehouse.module.video.apiservice.** { *; }
-keep class com.xlkj.beautifulpicturehouse.module.video.contract.** { *; }
-keep class com.xlkj.beautifulpicturehouse.module.video.view.** { *; }

-keep class com.xlkj.beautifulpicturehouse.module.home.apiservice.** { *; }
-keep class com.xlkj.beautifulpicturehouse.module.home.model.** { *; }
-keep class com.xlkj.beautifulpicturehouse.module.home.contract.** { *; }
-keep class com.xlkj.beautifulpicturehouse.module.home.view.** { *; }

-keep class com.xlkj.beautifulpicturehouse.module.mine.view.** { *; }
-keep class com.xlkj.beautifulpicturehouse.module.mine.contract.** { *; }
-keep class com.xlkj.beautifulpicturehouse.module.mine.apiservice.** { *; }

-keep class com.xlkj.beautifulpicturehouse.common.view.** { *; }
-keep class com.xlkj.beautifulpicturehouse.common.util.** { *; }
-keep class com.xlkj.beautifulpicturehouse.common.constant.** { *; }
#保持http不被混淆
-keep class com.xlkj.beautifulpicturehouse.common.http.** { *; }
...
# 保持实现带进度的Glide图片加载功能的类不被混淆
 -keep class com.xlkj.beautifulpicturehouse.common.manager.glideprogress.** { *; }
