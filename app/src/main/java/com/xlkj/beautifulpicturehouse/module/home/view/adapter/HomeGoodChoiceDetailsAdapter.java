...
public class HomeGoodChoiceDetailsAdapter extends RecyclerView.Adapter{

    private Context mContext;
    private ArrayList<ArrayList<GoodDetailResBean.DataBean.SelectedImgListBean>> mList;

    public HomeGoodChoiceDetailsAdapter(Context mContext, ArrayList<ArrayList<GoodDetailResBean.DataBean.SelectedImgListBean>> mList) {
    ...
    private void jump2detail(int position,int localPosition) {
        ...
        ArrayList<GoodDetailResBean.DataBean.SelectedImgListBean> selectedImgListBeans = mList.get(position);
        ...
        for (int i = 0; i < selectedImgListBeans.size(); i++) {
            HomeHotNewResBean.DataBean.TypeListBean.ImagListBean bean = new HomeHotNewResBean.DataBean.TypeListBean.ImagListBean();
            String imageId = selectedImgListBeans.get(i).getImageId();
            String imageUrl = selectedImgListBeans.get(i).getImageUrl();
