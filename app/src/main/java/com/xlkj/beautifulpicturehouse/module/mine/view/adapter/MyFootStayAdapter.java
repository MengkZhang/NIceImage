...
public class MyFootStayAdapter extends RecyclerView.Adapter {
    private Context mContext;
    private List<MyFootStayResBean.DataBean.TodayListBean> mList;

    public MyFootStayAdapter(Context mContext,List<MyFootStayResBean.DataBean.TodayListBean> mList) {
